...
Item {
    ...
    readonly property bool existsWindowActive: operatingWindow.isValid && !lastActiveTaskItem.isMinimized && lastActiveTaskItem.isActive
    readonly property bool existsWindowShown: operatingWindow.isValid && !lastActiveTaskItem.isMinimized
    readonly property bool existsWindowMaximized: operatingWindow.isValid && lastActiveTaskItem.isMaximized && !lastActiveTaskItem.isMinimized
    ...
    readonly property Item operatingTaskItem: Item {
        ...
        readonly property int winId: operatingWindow.hasOwnProperty("winId") ? operatingWindow.winId : -1
    }
